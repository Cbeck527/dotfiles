...
2. Decide approach based on scope:
   ...
   **For larger changes (use git-commit agent):**

   - Multiple features or significant changes
   - 3+ files with substantial modifications

   - For **each** new feature or significant change, spawn a task with the git-committer. That agent should be instructed to:
...
3. Wait for documentation agents to finish

After making your changes, briefly list the commits made.
